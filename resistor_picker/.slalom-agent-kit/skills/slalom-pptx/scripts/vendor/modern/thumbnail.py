...
# slalom-pptx vendor patch: upstream uses `from office.soffice import ...` because
# upstream organizes shared helpers under `office/`. We flattened that segment
# (archive-depth limit), so soffice.py is now a sibling of thumbnail.py.
